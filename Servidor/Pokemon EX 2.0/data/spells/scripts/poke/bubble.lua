...
setCombatParam(combat1, COMBAT_PARAM_TYPE, COMBAT_WATERDAMAGE)
...
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_WATERDAMAGE)
...
setCombatParam(combat3, COMBAT_PARAM_TYPE, COMBAT_WATERDAMAGE)
