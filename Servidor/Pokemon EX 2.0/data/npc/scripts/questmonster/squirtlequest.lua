...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "mission") then
		...
		if(str < 2) then
			npcHandler:say("Great, an adventurer. I need you to slays 100 squirtles for me. And then, we might be able to take out those bug lords. Well, can you slay 100 squirtles for me?", cid) 
			talkState[talkUser] = 1
			return true
		elseif(str == 2) then
			npcHandler:say("Please come back for a reward.", cid)
		elseif(str == 3) then
			npcHandler:say("100 squirtles, already? You're a true squirtle hunter! As I promised, here's your reward.", cid)
